...
def test_push_linked_list():
    """Test the push method in our Linked_List class."""
    from linked_list import Linked_List
    lst = Linked_List()
    lst.push(2)
...
def test_pop_empty_linked_list():
    """Test pop method in our Linked_List class wit empty list."""
    from linked_list import Linked_List
    lst = Linked_List()
...
def test_pop_linked():
    ...
    from linked_list import Linked_List
    lst = Linked_List([1, 2, 3, 4, 5])
    assert lst.pop() == 5


def test_size():
    """Test size method on Linked_List class."""
    from linked_list import Linked_List
    lst = Linked_List()
    lst.push(2)
    lst.push(3)
...
def test_search_linked_list_empty():
    """Test search method in our Linked_List class."""
    from linked_list import Linked_List
    lst = Linked_List()
...
def test_remove_linked_list_single():
    """Test remove method in our Linked_List class."""
    from linked_list import Linked_List
    lst = Linked_List()
    lst.push(2)
    lst.remove(2)
